export const SUBJECT_CODES: Record<string, string> = {
  ...
  "Biotechnology and Biotherapeutics": "BT",
  "Pharmaceutical Education and Professional Pharmacy": "PE",
  "Drug Regulatory Affairs & Pharmaceutical Management": "DR",
  "Artificial Intelligence / Bioinformatics / Data Analytics": "AI",
};
