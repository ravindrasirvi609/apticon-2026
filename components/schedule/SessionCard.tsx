  ...
  return (
    <div className="flex gap-4 group">
      ...
      <div className="flex flex-col items-center flex-shrink-0">
        <div className={`w-4 h-4 rounded-full border-2 mt-1 transition-all duration-300
          ${session.type === "break" || session.type === "logistics"
            ...
            : "border-[var(--crimson-800)] bg-white group-hover:bg-[var(--crimson-800)]"
          }`}
        />
        {index >= 0 && (
          <div className="w-px flex-1 bg-gradient-to-b from-[var(--gold-500)]/40 to-transparent mt-1 min-h-[2rem]" />
        )}
      </div>
      ...
      <div className={`flex-1 mb-4 rounded-2xl p-4 border transition-all duration-300
        ${session.type === "break" || session.type === "logistics"
          ? "bg-[var(--cream-100)] border-[var(--cream-200)]"
          : "bg-white border-[var(--gold-500)]/15 hover:border-[var(--gold-500)]/40 hover:shadow-md"
        }`}
      >
