        ...
        >
          <div className="bg-gradient-to-r from-[var(--accent-500)] via-[var(--accent-400)] to-[var(--accent-500)] text-[var(--dark-text)] py-2 px-4 relative">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-black/10 transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary-800)]"
            >
