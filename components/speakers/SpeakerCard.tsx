    ...
    <div className="flip-card group h-64">
      <div className="flip-card-inner h-full">
        ...
        <div className="flip-card-front h-full rounded-2xl bg-white border border-[var(--accent-500)]/20 shadow-sm flex flex-col items-center justify-center p-5 text-center gap-3">
          ...
          <div>
            <p className="font-display font-bold text-base text-[var(--dark-text)] leading-snug">
              {speaker.name}
            </p>
            <p className="text-xs text-[var(--muted-text)] mt-0.5 leading-snug">
              {speaker.title}
            </p>
            <p className="text-xs text-[var(--muted-text)] leading-snug">
              {speaker.institution}
            </p>
          </div>
          <span
            className={`text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full ${roleStyles[speaker.role]}`}
          >
        ...
        <div className="flip-card-back h-full rounded-2xl bg-[var(--dark-text)] border border-[var(--accent-500)]/20 flex flex-col items-center justify-center p-5 text-center gap-3">
          ...
          />
          <p className="font-display font-bold text-base text-[var(--accent-400)] leading-snug">
            {speaker.name}
          </p>
          {speaker.topic && (
            <>
