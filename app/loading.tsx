  ...
  return (
    <div className="min-h-[50dvh] flex flex-col items-center justify-center gap-4" aria-label="Loading">
      ...
      <div className="relative w-16 h-16">
        ...
        <div className="absolute inset-2 rounded-full border-4 border-t-[var(--primary-800)] border-transparent animate-[spin_1.5s_linear_infinite]" />
        <div className="absolute inset-4 rounded-full bg-[var(--accent-500)]/20 animate-pulse" />
      </div>
