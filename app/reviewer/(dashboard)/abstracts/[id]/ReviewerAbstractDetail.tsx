    ...
    <div className="p-4 md:p-8 max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="mt-4">
                  <a href={a.fileUrl} target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="sm">
                      <FileText className="w-4 h-4" /> Open attached file{" "}
            ...
            <CardContent className="space-y-4">
              {a.finalDecision ? (
                <p className="text-sm text-[var(--muted-text)]">
                  This abstract has already been finalized (
                  {a.finalDecision.replace("_", " ")}) — no further review can
                  be submitted.
                </p>
              ) : (
                <>
                  <div>
                    ...
                    <p className="mt-1 text-xs text-[var(--muted-text)]">
                      Checking this finalizes the abstract as accepted
                      immediately — no further confirmation from admin or
                      editorial is needed.
                    </p>
                  </div>
                  ...
                  {accept ? (
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs text-[var(--muted-text)]">
                        This is a recommendation only — admin/editorial will be
                        emailed to make the final decision.
                      </p>
                    </div>
                  )}
                  ...
                  <div>
                    <Label htmlFor="comments">
                      Public comments (shared with author) *
                    </Label>
                    <Textarea
                      id="comments"
                      className="mt-2"
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Only visible to the super admin"
                    />
                  </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Other reviews</CardTitle>
            </CardHeader>
              ...
              {data.reviews
                ...
                .map((r) => {
                  ...
                  return (
                    <div
                      key={r._id}
                      className="p-3 rounded-lg border border-[var(--accent-500)]/20 text-sm"
                    >
                      ...
                      <div className="text-xs text-[var(--muted-text)] mb-2">
