...
const SPEAKERS: Speaker[] = [
  { name: "Chief Guest",        title: "Eminent Personality",                 institution: "To Be Announced", role: "keynote",  topic: "Vision for Pharmacy Education in India" },
  { name: "Keynote Speaker",    title: "Distinguished Professor",             institution: "To Be Announced", role: "keynote",  topic: "Viksit Pharmacist for Atmanirbhar Bharat" },
  { name: "Invited Speaker I",  title: "Professor & Head",                   institution: "To Be Announced", role: "invited",  topic: "Pharmaceutical Education Innovation" },
  { name: "Invited Speaker II", title: "Senior Researcher",                  institution: "To Be Announced", role: "invited",  topic: "Drug Discovery in India" },
  { name: "Invited Speaker III","title": "Dean, Pharmacy",                   institution: "To Be Announced", role: "invited",  topic: "Clinical Pharmacy Practice" },
  { name: "Invited Speaker IV", title: "Professor",                          institution: "To Be Announced", role: "invited",  topic: "Herbal & Traditional Medicine" },
  { name: "Invited Speaker V",  title: "Associate Professor",                institution: "To Be Announced", role: "invited",  topic: "Regulatory Affairs & Quality" },
  { name: "Workshop Facilitator", title: "Expert Educator",                  institution: "To Be Announced", role: "workshop", topic: "Outcome-Based Pharmacy Education" },
  { name: "Session Chair I",    title: "Professor",                          institution: "To Be Announced", role: "chair" },
  { name: "Session Chair II",   title: "Professor & Principal",              institution: "To Be Announced", role: "chair" },
  { name: "Session Chair III",  title: "Head of Department",                 institution: "To Be Announced", role: "chair" },
  { name: "Session Chair IV",   title: "Dean",                               institution: "To Be Announced", role: "chair" },
];
        ...
        <div className="container-site">
          ...
          >
            ...
            <p className="text-white/70 text-sm max-w-md mx-auto mb-6">
              Check back soon — we are in the process of finalising a stellar speaker lineup from across India and beyond.
            </p>
            <a
