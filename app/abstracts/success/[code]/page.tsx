      ...
      <Card className="w-full max-w-lg text-center">
        <CardContent className="pt-10 pb-10">
          ...
          <p className="text-[var(--muted-text)]">
            Thank you — your abstract has been submitted to APTICON 2026.
          </p>
          ...
          <p className="mt-6 text-sm text-[var(--muted-text)]">
            A confirmation email has been sent. Please save your submission code
            — you'll need it to check the review status of your abstract.
          </p>
