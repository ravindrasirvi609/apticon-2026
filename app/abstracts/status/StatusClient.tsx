    ...
    <div className="min-h-[80vh] px-4 py-16">
      <div className="max-w-2xl mx-auto text-center mb-8">
        ...
        <p className="mt-3 text-[var(--muted-text)]">
          Enter your submission code and email to view the current status.
        </p>
      </div>
      ...
      {result && (
        <Card className="max-w-2xl mx-auto mt-8">
          ...
          <CardContent className="space-y-3 text-sm">
            <div>
              <b>Presenting author:</b> {result.presentingAuthor}
            </div>
            <div>
              <b>Theme:</b> {result.theme}
            </div>
            <div>
            ...
            {result.finalDecisionAt && (
              <div>
                ...
                {format(new Date(result.finalDecisionAt), "d MMM yyyy, h:mm a")}
              </div>
            )}
