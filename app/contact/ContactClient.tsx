...
export default function ContactClient() {
  ...
  const inputCls = (err?: boolean) => `
    ...
    ${err ? "border-red-400 bg-red-50" : "border-[var(--accent-500)]/25 hover:border-[var(--accent-500)]/60"}
  `;
            ...
            <div className="space-y-5">
              ...
              {CONTACTS.map(({ icon: Icon, label, value, href }) => (
                <ScrollReveal key={label}>
                  <div className="flex gap-4 items-start p-4 rounded-2xl bg-white border border-[var(--accent-500)]/15 shadow-sm">
              ...
              {submitted ? (
                ...
                <ScrollReveal>
                  <form
                    ...
                    noValidate
                    className="rounded-2xl bg-white border border-[var(--accent-500)]/20 shadow-sm p-6 md:p-8 space-y-5"
                  >
                    ...
                    <button
                      ...
                      className="w-full py-4 rounded-xl font-bold text-base bg-[var(--primary-800)] text-white hover:bg-[var(--primary-700)] disabled:opacity-60 transition-all duration-200 shadow-md focus:outline-none focus:ring-2 focus:ring-[var(--accent-400)] focus:ring-offset-2"
                    >
